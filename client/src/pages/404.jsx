...
const NotFound = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br pt-40 from-gray-100 via-blue-50 to-indigo-100 overflow-hidden flex items-center justify-center pb-10">
