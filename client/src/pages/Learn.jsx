...
const Learn = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-700 via-purple-700 to-purple-900 text-white pt-40">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-lg border border-white/10 hover:scale-105 transition-transform">
            ...
            <p className="text-purple-100">
              Watch easy-to-understand videos covering key driving scenarios and
              maneuvers.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-lg border border-white/10 hover:scale-105 transition-transform">
            ...
            <h3 className="text-2xl font-semibold mb-2">Quizzes & Practice</h3>
            <p className="text-purple-100">
